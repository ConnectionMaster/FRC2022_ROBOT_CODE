...
public class MotionControllSubsystem extends SubsystemBase {
    ...
    private MotorControllerGroup Spg_Right , Spg_Left; // Controller Group objects
    ...
    public MotionControllSubsystem(){
        ...
        this.Spg_Left = new MotorControllerGroup(MotorLeftFront, MotorLeftRear);
        this.Spg_Right = new MotorControllerGroup(MotorRightFront, MotorRightRear);
