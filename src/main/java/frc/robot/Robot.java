...
public class Robot extends TimedRobot {
 ...
 // public static double angle = 0;
  ...
  public void teleopPeriodic() {
    ...
    //m_robotContainer.CommandStickButtons[4].whileHeld(m_robotContainer.getPullOutCommand());
    m_robotContainer.CommandStickButtons[3].whileHeld(m_robotContainer.getPullCommand());
  }
